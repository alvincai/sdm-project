...
class Patient:
    ...
    def addEntity(self, EntityID, HealthRecordType):
        ...
        self.genRencryptionK(HealthRecordType, EntityID)
    ...
    def genRencryptionK(self, recordType, ID2):
        if recordType.lower() == "general":
            sk = self.General[1]
            ID = self.General[0]
        elif recordType.lower() == "medical":
        ...
        self.proxy.addKey(ID, ID2, reEncryptionKey)  # store this key at the proxy
